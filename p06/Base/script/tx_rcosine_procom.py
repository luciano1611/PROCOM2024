...
#PRBS BITS y aplicar transformacion 1:0-> -1:1
...
# FILTER OUT: CONV
symb_out0I = np.convolve(rc0,zsymbI,'same'); symb_out0Q = np.convolve(rc0,zsymbQ,'same') # SEÑAL DISCRETA (flota values)
...
#RECEPCION: DOWNSAMPLING
#APLICAR TRUNCADO PARA QUE VAYA DE 1:-1
#BER symb_out0I and symbolsI
