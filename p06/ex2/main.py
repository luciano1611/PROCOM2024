...
print(f"Valor de cuantificacion : {s        }")
...
### [1.b]: Funcion de cuantizacion en punto Fijo
...
# Llamada a la funcion de cuantificacion de la rc
rc     = quantum(rc, s, op='round')
