## Este archivo es un .xdc general para el ARTY  Rev. B
## Para usarlo en un proyecto:
## - descomenta las líneas correspondientes a los pines usados
## - renombra los puertos usados (en cada línea, después de get_ports) según los nombres de las señales de top_level en el proyecto
